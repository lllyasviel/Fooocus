import torch
from cbh.ldm.modules.diffusionmodules.openaimodel import UNetModel
from cbh.ldm.modules.encoders.noise_aug_modules import CLIPEmbeddingNoiseAugmentation
from cbh.ldm.modules.diffusionmodules.util import make_beta_schedule
from cbh.ldm.modules.diffusionmodules.openaimodel import Timestep
...
class BaseModel(torch.nn.Module):
    ...
    def state_dict_for_saving(self, clip_state_dict, vae_state_dict):
        ...
        unet_state_dict = {}
        for k in unet_sd:
            unet_state_dict[k] = cbh.model_management.resolve_lowvram_weight(unet_sd[k], self.diffusion_model, k)
