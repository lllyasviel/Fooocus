            ...
            with gr.Tab(label='Model'):
                with gr.Group():
                    with gr.Row():
                        ...
                        refiner_model = gr.Dropdown(label='Refiner (SDXL or SD 1.5)', choices=['None'] + modules.config.refiner_filenames, value=modules.config.default_refiner_model_name, show_label=True)
