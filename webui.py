...
parser.add_argument("--listen", type=str, default="127.0.0.1", metavar="IP", nargs="?", const="0.0.0.0", help="Set the listen host.")
parser.add_argument("--port", type=int, default=None, help="Set the listen port.")
args = parser.parse_args()
shared.gradio_root.launch(inbrowser=True, server_name=args.listen if '--listen' in sys.argv else None, server_port=args.port)
