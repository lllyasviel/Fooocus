    ...
    with gr.Row():
        ...
        with gr.Column(scale=1, visible=modules.config.default_advanced_checkbox) as advanced_column:
            ...
            with gr.Tab(label='Wildprompt'):
                ...
                wildprompt_generate_all = gr.Checkbox(label='Generate All Wildprompts', value=False, container=False, elem_classes='min_check', info='When Generate All Wildprompts is selected it will create an image for each prompt in the selected file. Increase the Image Number to increase the number of times each prompt is generated. Only works if 1 wildprompt is selected.', interactive=True)
