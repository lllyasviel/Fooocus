...
def load_clip_weights(model, sd):
    ...
    sd = ldm_patched.modules.utils.clip_text_transformers_convert(sd, "cond_stage_model.model.", "cond_stage_model.transformer.")
...
def load_style_model(ckpt_path):
    ...
    if "style_embedding" in keys:
        model = ldm_patched.modules.t2i_adapter.adapter.StyleAdapter(width=1024, context_dim=768, num_head=8, n_layes=3, num_token=8)
    else:
