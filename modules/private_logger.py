...
def log(img, dic, single_line_number=3):
    ...
    item += "<table><tr>"
    item += f"<td><a href=\"{only_name}\"><img src=\"{only_name}\" width=auto height=100% loading=lazy style=\"height:auto;max-width:512px\" onerror=\"document.getElementById('{div_name}').style.display = 'none';\"></img></a></td>"
