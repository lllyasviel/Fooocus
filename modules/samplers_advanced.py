...
try:
    from comfy.samplers import resolve_areas_and_cond_masks as resolve_cond_masks
except:
    pass
...
class KSamplerWithRefiner:
    ...
    def sample(
        ...
        def refiner_switch():
            modules.virtual_memory.try_move_to_virtual_memory(
                self.model_denoise.inner_model
            )
            modules.virtual_memory.load_from_virtual_memory(
                self.refiner_model_denoise.inner_model
            )
