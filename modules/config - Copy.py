...
default_base_model_name = get_config_item_or_set_default(
    key='default_model',
    default_value='DreamShaperXL_Turbo_dpmppSdeKarras_half_pruned_6.safetensors',
...
default_prompt_negative = get_config_item_or_set_default(
    ...
    default_value='[embedding:bhands-neg]bhands1,[embedding:easynegative]',
    validator=lambda x: isinstance(x, str),
    disable_empty_as_none=True
)
default_prompt = get_config_item_or_set_default(
    key='default_prompt',
    default_value='high detail, best',
    validator=lambda x: isinstance(x, str),
    disable_empty_as_none=True
)
...
available_aspect_ratios = get_config_item_or_set_default(
    ...
    default_value=[
        ...
        '1664*576', '1728*576' '1536*1024', '1024*1536', '153681536'
    ],
