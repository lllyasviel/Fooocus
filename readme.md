...
Below is a test on a relatively low-end laptop with **16GB System RAM** and **6GB VRAM** (Nvidia 3060 laptop). The speed on this machine is about 1.35 second per iteration. The speed on this machine is about 1.35 second per iteration. Pretty impressive – nowadays laptops with 3060 is usually at very acceptable price.
