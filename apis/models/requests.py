...
class CommonRequest(BaseModel):
    ...
    uov_input_image: str | None = Field(default=None, description="Upscale or Vary Input Image")
    outpaint_selections: List[OutpaintExpansion] = Field(default=[], description="Outpaint Expansion")
    inpaint_input_image: str | None = Field(default=None, description="Inpaint Input Image")
